...
pyplot.show()
 ...
 # we can also use clipnorm =1.0 and clipvalue=5.0 to 
 #rescale the gradient ascent for better performance. this is used whil using the
 # compilation for optimizer='SGD'
