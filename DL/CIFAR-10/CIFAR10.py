# -*- coding: utf-8 -*-
"""
Created on Mon Feb 25 12:31:56 2019
...
def load_cifar10_data(batch_number):
    with open('C:/Users/a.kumar/Documents/LEARNING/DataScience/DL/CIFAR-10/data_batch_'+ str(batch_number), 'rb') as file:
...
# working on labels to convert number to some words
...
#For purpose of simplicity, I load different 1-D numpy arrays into one single 
#batch of 40000 images. The first 8000 arrays or images from each batch are 
#appended to a single batch of X_train
